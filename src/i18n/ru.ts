...
export const ru = {
  ...
  'editor.preset.volume': 'Объём посуды, мл',
  ...
  'editor.step.temp': 'Темп., °C',
  'editor.step.pour': 'Вода, мл',
  'editor.step.label': 'Метка',
  'editor.step.label.placeholder': 'необязательно',
  'editor.step.rinse': 'Промывка',
  'editor.step.rinse.hint':
    'Время можно вводить в секундах (45) или как м:сс (1:15). Промывка не считается проливом при нумерации.',
