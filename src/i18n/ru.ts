...
export const ru = {
  ...
  'editor.step.rinse.hint':
    'Время вводится как м:сс, цифры набегают справа: 25 → 0:25, 200 → 2:00, 115 → 1:15. Промывка не считается проливом при нумерации. Температура задаётся один раз сверху — на все проливы.',
